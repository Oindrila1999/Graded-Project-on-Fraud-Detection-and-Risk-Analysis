...
WHERE C.ADDRESS NOT LIKE CONCAT('%',T.TXN_IP_LOCATION,'%')
ORDER BY T.TRASACTION_DATE DESC;
...
GROUP BY C.ADDRESS,C.NAME,L.LOAN_PURPOSE
...
SELECT 
    L.LOAN_STATUS,
    AVG(C.SENTIMENT_SCORE) AS AVERAGE_SENTIMENT_SCORE,
